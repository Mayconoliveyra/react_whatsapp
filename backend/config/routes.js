module.exports = (app) => {
    app.route("/autenticacao-status").post(app.api.whatsappMain.login);

    app.route("/autenticacao-whatsapp").get(
        app.api.whatsappMain.mainWppAutenticar
    );

    app.route("/get-status-whatsapp").get(
        app.api.whatsappMain.getStatusAutenticacao
    );
