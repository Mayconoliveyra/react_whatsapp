...
module.exports = app => {
    ...
    return { existeOuErro, naoExisteOuErro, naoExisteNoBancoOuErro, existeNoBancoOuErro, criptografar, descriptografar, util_console, msgPadraoErro, dataAtualFormatadaBR, contatoValidoOuErro }
}
